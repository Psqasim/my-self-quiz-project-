...
if (ask.ask) {console.log(chalk.green.underline`WELCOME TO SIMPLE ISLAMIC QUIZZ GAME `);
...
if (quest.quest==="A JANNAH") {console.log(chalk.green`correct answer`);  
score++;// Increment score for correct answer
}
else{console.log(chalk.red`Sorry, that's not correct.\nThey live  beginning in the JANNAH`);
}
